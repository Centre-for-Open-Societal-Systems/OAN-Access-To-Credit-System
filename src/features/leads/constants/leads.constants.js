...
export const STATUS_OPTS = ['All', 'Initiated', 'Qualified', 'Processed', 'Disqualified', 'Rejected'];

export const DATE_OPTS = ['All Time', 'Last 7 Days', 'Last 30 Days', 'Last 90 Days'];

export const PAGE_SIZE = 10;

export const COL_FILTER_OPTS = {
