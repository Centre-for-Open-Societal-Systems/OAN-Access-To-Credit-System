...
function getKpiIconCfg(id: string) {
  switch (id) {
    ...
    case 'initiated': return { bg: 'bg-green-100', icon: <ClipboardList size={28} className="text-green-500" /> };
    case 'qualified': return { bg: 'bg-teal-100', icon: <CheckCircle2 size={28} className="text-teal-500" /> };
